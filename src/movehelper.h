...
inline BB rook_moves(int sq, BB occupied_bb)
{
  return Chess_Lookup::Fancy::GetRookAttacks(sq, occupied_bb);
}
...
{
  return Chess_Lookup::Fancy::GetQueenAttacks(sq, occupied_bb);
}
